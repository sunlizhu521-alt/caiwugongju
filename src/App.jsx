...
const API = import.meta.env.DEV ? 'http://localhost:4008' : '';
const TOKEN_KEY = 'caiwugongjuToken';
const ACTIVE_PAGE_KEY = 'caiwugongjuActivePage';
...
const FILTER_CACHE_PREFIX = 'caiwugongju:filters:';
...
function SecurityWatermark({ userName }) {
  ...
  const text = `财务工具 · ${normalize(userName) || '已登录用户'} · ${time}`;
  return (
